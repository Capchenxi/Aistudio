...
class VGGNet(fluid.dygraph.Layer):
    ...
    def __init__(self):
        ...
        self.conv1 = ConvPool(num_channels=3, num_filters=64, filter_size=3, pool_size=3, pool_stride=2, groups=2, act='relu')
        self.conv2 = ConvPool(num_channels=64, num_filters=128, filter_size=3, pool_size=3, pool_stride=2, groups=2, act='relu')
        self.conv3 = ConvPool(num_channels=128, num_filters=256, filter_size=3, pool_size=3, pool_stride=2, groups=3, act='relu')
        self.conv4 = ConvPool(num_channels=256, num_filters=512, filter_size=3, pool_size=3, pool_stride=2, groups=3, act='relu')
        self.conv5 = ConvPool(num_channels=512, num_filters=512, filter_size=3, pool_size=3, pool_stride=2, groups=3, act='relu')

        self.fc1 = fluid.dygraph.Linear(512*4*4, 4096, act='relu')
    ...
    def forward(self, inputs, label=None):
        ...
        x5 = fluid.layers.reshape(x5, shape=[-1, 512*4*4])
        # print(x5.shape)
